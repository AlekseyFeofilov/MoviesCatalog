//
//  FavoriteStackWithPromotedMovie.swift
//  MovieCatalog
//
...
struct PromotedMovie: View {
    ...
    var body: some View {
        ZStack (alignment: .bottom) {
            CustomAsyncImage(url: url, failureImage: Image(systemName: "photo"))
                .frame(height: 250)
                .clipped()
            ...
            VStack{
                ...
                .background(
                    RoundedRectangle(cornerRadius: 4)
                        ...
                        .frame(width: 160, height: fieldHeight)
                )
            }
            .padding(.bottom, 32)
        }
