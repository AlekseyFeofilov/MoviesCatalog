...
struct GalleryMovie: View, Identifiable {
    var id: String
    var name: String
    var imageUrl: String
    var year: Int
        ...
        ScrollView(.vertical, showsIndicators: false) {
            HStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("\(country) \u{2022} " + String(year))
                    Text(genres.map( { $0.name }).sorted().joined(separator: ", "))
                    Spacer()
                    Ratting(ratting)
                }
        ...
        ZStack {
            ...
            GalleryMovie(
                ...
                genres: [
                    ...
                    genre(id: "b4e44ca7-7b96-4d12-aed3-08d9b9f3d27c", name: "мелодрама"),
                    genre(id: "5fb99899-1833-4e9e-aed7-08d9b9f3d27c", name: "военный"),
                    genre(id: "279e470a-11dc-46e2-aeda-08d9b9f3d27c", name: "история"),
                    genre(id: "9bba1883-a1fc-448a-aedb-08d9b9f3d27c", name: "драма")
                ],
                ratting: 5.7
            )
        }
